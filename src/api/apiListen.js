export const TopicListen = [
  {
    ...
    background: require("../img/imgListen/topicListen/climateChange.png"),
    list: [
      {
        id: 1,
        image: require("../img/imgListen/imgClimateChange/climate_1.png"),
        title:
          "Melting glaciers force Switzerland and Italy to redraw part of their border",
        link: "https://www.cnn.com/2024/10/01/climate/melting-glaciers-border-switzerland-italy/index.html",
        content: [
          {
            id: 1,
      ...
      {
        id: 2,
        image: require("../img/imgListen/imgClimateChange/climate_2.png"),
        title:
          "Mysterious magma in extinct volcanoes may be filled with elements needed to power the future",
        link: "https://www.cnn.com/2024/09/24/climate/magma-extinct-volcanoes-rare-earth-metals/index.html",
        content: [
          {
            id: 1,
            text: "A mysterious type of magma found within extinct volcanoes scattered around the world could contain an abundant supply of rare earth elements, crucial ingredients for electric vehicles, wind turbines and other clean technologies, according to a report published Tuesday.",
          },
          {
            id: 2,
            text: "Rare earth elements, such as lanthanum, neodymium and terbium, are critical for helping the world break its long, destructive relationship with planet-heating fossil fuels.",
          },
          {
            id: 3,
            text: "These materials — so-called rare earths — are not actually that rare but can be challenging to extract as they are often found in low concentrations. As demand for them ramps up, many countries are scrambling to find new sources to break their dependence on China, which currently dominates the supply chain.",
          },
          {
            id: 4,
            text: "The new study “potentially opens a new avenue for rare earth extraction,” said Michael Anenburg, a research fellow at the Australian National University and a study author.",
          },
          {
            id: 5,
            text: "The research was inspired by last year’s discovery of an enormous deposit of rare earth elements in Kiruna in Arctic Sweden, a mining town that sits upon a huge mass of iron-ore, formed around 1,600 million years ago following intense volcanic activity.",
          },
          {
            id: 6,
            text: "For scientists at the Australian National University and the University of the Chinese Academy of Sciences, it raised a big question: why were the rare earths there?",
          },
          {
            id: 7,
            text: "They wanted to understand whether this was “a geological accident, or is there something inherent about those iron-rich volcanoes that makes them rich in rare earth elements?” Anenburg told CNN.",
          },
          {
            id: 8,
            text: "They couldn’t visit one to find out — this type of volcano is incredibly rare. “We have never seen an iron-rich magma erupt from an active volcano, but we know some extinct volcanoes, which are millions of years old, had this enigmatic type of eruption,” Anenburg said.",
          },
          {
            id: 9,
            text: "So the scientists simulated a magma chamber in their lab using a synthetic rock with a similar composition to those from these extinct volcanoes, putting it into a pressurized furnace and heating it to extremely high temperatures.",
          },
          {
            id: 10,
            text: "Once the rock melted and became “magmatic,” the iron-rich magma absorbed all the rare earth elements from its surrounding environment, according to the study, which concluded this iron-rich magma was up to 200 times more efficient at concentrating rare earths than the magma that commonly erupts from regular volcanoes.",
          },
          {
            id: 11,
            text: "The findings suggest there could be unexplored deposits of rare earths in extinct volcanoes across the world, including in the United States, Chile and Australia.",
          },
          {
            id: 12,
            text: "Many of these sites are already mined for iron-ore, making it a potential “win-win” for companies and the environment, Anenburg said. Companies can get more value from the mine and “we might no longer have to dig up resources from a new place,” he said.",
          },
          {
            id: 13,
          ...
          {
            id: 14,
            text: "It will be valuable information to geologists in the field to help them find rich, economically viable deposits which could help diversify the rare earth supply chain, she told CNN.",
          },
          {
            id: 15,
            text: "Rare earth mining has been plagued with environmental problems because of the use of toxic chemicals which can pollute the soil and groundwater. Human rights groups have also reported allegations of human rights abuses in the supply chain, including child labor.",
          },
          {
            id: 16,
            text: "Some experts have suggested there should be more of a focus on recycling rare earth elements rather than mining.",
          },
          {
            id: 17,
...

  {
    id: 11,
    title: "Xe điện",
    background: require("../img/imgListen/topicListen/electricBike.png"),
    list: [],
  },
  {
    id: 12,
    title: "Thể thao",
    background: require("../img/imgListen/topicListen/sport.png"),
    list: [],
  },
  {
    id: 13,
    title: "Cung - Cầu",
    background: require("../img/imgListen/topicListen/supply_demand.png"),
    list: [],
  },
  {
    id: 14,
    title: "Hệ mặt trời",
    background: require("../img/imgListen/topicListen/universe.png"),
    list: [],
  },
];
